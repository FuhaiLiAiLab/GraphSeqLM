...
def build_graphclas_model(args, num_node, device):
    model = GCNDecoder(input_dim=args.train_input_dim, 
...
def arg_parse():
    ...
    parser.add_argument('--train_result_path', nargs='?', dest='train_result_path', default='gcn', help='save path for model result.')
