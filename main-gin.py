...
from models.gnn.geo_gin_decoder import GINDecoder
...
def build_graphclas_model(args, num_node, device):
    model = GINDecoder(input_dim=args.train_input_dim, 
...
def arg_parse():
    ...
    parser.add_argument('--train_lr', dest='train_lr', type=float, default=0.0025, help='Learning rate for training. (default: 0.0025)')
    ...
    parser.add_argument('--train_result_path', nargs='?', dest='train_result_path', default='gin', help='save path for model result.')
